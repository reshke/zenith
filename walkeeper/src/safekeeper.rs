...
impl SafeKeeperMetrics {
    fn new(ztli: ZTimelineId, commit_lsn: Lsn) -> Self {
...
/// replies.
pub struct SafeKeeper<ST: control_file::Storage> {
    ...
    pub control_store: ST,
    pub wal_store: wal_storage::PhysicalStorage,
}

impl<ST> SafeKeeper<ST>
where
    ST: control_file::Storage,
{
    // constructor
    pub fn new(
        ztli: ZTimelineId,
        control_store: ST,
        wal_store: wal_storage::PhysicalStorage,
        ...
        SafeKeeper {
            metrics: SafeKeeperMetrics::new(ztli, state.commit_lsn),
    ...
    fn handle_greeting(
        ...
        self.metrics = SafeKeeperMetrics::new(msg.ztli, self.commit_lsn);
