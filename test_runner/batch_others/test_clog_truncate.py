...
def test_clog_truncate(zenith_simple_env: ZenithEnv):
    ...
    test_clog_truncate_timeline_id = env.zenith_cli.create_timeline()
    ...
    pg = env.postgres.create_start('test_clog_truncate',
                                   config_lines=config,
                                   timeline=test_clog_truncate_timeline_id)
    ...
    test_clog_truncate_new_timeline_id = env.zenith_cli.create_timeline(
    ...
    pg2 = env.postgres.create_start('test_clog_truncate_new',
                                    timeline=test_clog_truncate_new_timeline_id)
