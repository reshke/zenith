...
def test_vm_bit_clear(zenith_simple_env: ZenithEnv):
    ...
    test_vm_bit_clear_timeline_id = env.zenith_cli.create_timeline()
    pg = env.postgres.create_start('test_vm_bit_clear', timeline=test_vm_bit_clear_timeline_id)
    ...
    test_vm_bit_clear_new_timeline_id = env.zenith_cli.create_timeline(
    ...
    pg_new = env.postgres.create_start('test_vm_bit_clear_new',
                                       timeline=test_vm_bit_clear_new_timeline_id)
