...
def test_restart_compute(zenith_env_builder: ZenithEnvBuilder, with_wal_acceptors: bool):
    ...
    pg = env.postgres.create_start('test_restart_compute', timeline=new_timeline_id)
    ...
    pg.stop_and_destroy().create_start('test_restart_compute', timeline=new_timeline_id)
