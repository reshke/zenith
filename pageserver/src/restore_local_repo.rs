...
use crate::waldecoder::{decode_wal_record, Oid, WalStreamDecoder, DecodedWALRecord};
...
fn save_create_database(
    ...
    for src_rel in rels {
        ...
        for blknum in 0..nblocks {
            let src_key = BufferTag { rel: src_rel, blknum };
            let dst_key = BufferTag { rel: dst_rel, blknum };
